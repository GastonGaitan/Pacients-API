from fastapi import Depends, FastAPI, HTTPException, Path, status, Form, UploadFile
...
@app.delete("/delete_pacient/{pacient_id}", status_code=status.HTTP_204_NO_CONTENT)
